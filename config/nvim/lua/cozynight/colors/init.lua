...
---@type table<string, Palette|fun(opts:cozynight.Config):Palette>
M.styles = setmetatable({}, {
  __index = function(_, style)
    return vim.deepcopy(Util.mod("cozynight.colors." .. style))
  end,
})
...
function M.setup(opts)
  ...
  colors.bg_statusline = colors.terminal_black
