...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("cozynight.hsluv")
    if color ~= "NONE" then
...
---@param groups cozynight.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/cozynight-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, cozynight.Cache
