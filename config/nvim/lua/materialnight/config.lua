...
M.defaults = {
  ...
  ---@param highlights materialnight.Highlights
  ---@param colors ColorScheme
  ...
  plugins = {
    ...
    --   * https://github.com/folke/materialnight.nvim/tree/main/lua/materialnight/groups
    -- telescope = true,
  },
}

---@type materialnight.Config
M.options = nil

---@param options? materialnight.Config
