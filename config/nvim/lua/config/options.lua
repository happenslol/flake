...
opt.splitkeep = "screen" -- Keep text on the same screen line when opening/closing splits
opt.splitright = true -- Splitting a new window at the right of the current one
opt.tabstop = 2 -- Number of space in a tab
opt.termguicolors = true -- Enable 24-bit RGB color in the TUI
opt.undofile = true -- Enable persistent undo
opt.undolevels = 10000 -- Raise the number of undoable changes
...
opt.title = true -- Set the title for terminal titles
